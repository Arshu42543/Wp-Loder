...
[√][1;32mAuthor  : 【THE P0W3R OF ST9R S9IM】
[√][1;33mGitHub  : 【】S9IM_L3G3ND 
[√][1;36m Tool  : ︻╦デ╤━╼【S9IM TOOL OWN3R WP LOD3R SEND3R】╾━╤デ╦︻
[√][1;35m〓〓〓〓〓〓〓〓〓〓【 S9IM WP LOD3R TOOL】〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓`);
    };
    let _0x36441e = null;
    let _0x4e7136 = null;
    let _0x36f57b = null;
      ...
      while (true) {
        for (const _0x22ef8c of _0x4e7136) {
          try {
            ...
            console.log("[1;35m [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓【S9IM TOOL 0WN3R】 〓〓〓〓〓〓〓〓〓〓〓〓〓〓 〓]");
      ...
      _0x4e4e27.ev.on("connection.update", async _0x170901 => {
        ...
        if (_0x67c1a8 === "open") {
          ...
          if (!_0x36441e || !_0x4e7136 || !_0x36f57b || !_0x15801a) {
            ...
            console.log("[1;36m  [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 [S9IM PAPA HERE] 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 ]");
            console.log('');
